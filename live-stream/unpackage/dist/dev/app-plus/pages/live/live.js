...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _fGift = _interopRequireDefault(__webpack_require__(/*! @/components/live/f-gift.vue */ 28));\nvar _fDanmu = _interopRequireDefault(__webpack_require__(/*! @/components/live/f-danmu.vue */ 33));\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! @/components/uni-ui/uni-popup/uni-popup.vue */ 10));\nvar _gifts = _interopRequireDefault(__webpack_require__(/*! @/common/gifts.js */ 40));\nvar _request = _interopRequireDefault(__webpack_require__(/*! @/common/request.js */ 39));\nvar _config = _interopRequireDefault(__webpack_require__(/*! @/common/config.js */ 38));\nvar _vuex = __webpack_require__(/*! vuex */ 41);var _components$mounted$d;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default = (_components$mounted$d = {\n\n  components: {\n    fGift: _fGift.default, fDanmu: _fDanmu.default, uniPopup: _uniPopup.default },\n\n  mounted: function mounted() {\n    //送礼物演示\n    // setInterval(() => {\n    // \tthis.$refs.gift.send({\n    // \t\tusername: '侯粤嘉',\n    // \t\tavatar: '',\n    // \t\tgit_name: '蛋糕',\n    // \t\tgit_image: '/static/gift/3.png',\n    // \t\tnum: 1\n    // \t})\n    // },3000)\n  },\n  data: function data() {\n    return {\n      id: 0,\n      detail: {\n        created_time: '',\n        id: 1,\n        title: '',\n        cover: '',\n        user_id: 0,\n        look_count: 0,\n        coin: 0,\n        key: '',\n        status: 0,\n        userId: 0,\n        user: {\n          id: 0,\n          username: '',\n          avatar: '' } },\n\n\n      sign: '',\n      statusBarHeight: 0,\n      content: '',\n      gifts: [],\n      giftActiveId: 0,\n      //在线用户列表\n      list: [] };\n\n  } }, _defineProperty(_components$mounted$d, \"mounted\", function mounted()\n{\n  // 加入直播间\n  this.joinOrLeaveLive('join');\n}), _defineProperty(_components$mounted$d, \"destroyed\", function destroyed()\n\n{\n  // 离开直播间\n  this.joinOrLeaveLive('leave');\n  // 移除全局事件\n  uni.$off('live', this.handleLiveEvent);\n}), _defineProperty(_components$mounted$d, \"onLoad\", function onLoad(\noption) {var _this = this;\n  this.id = option.id;\n  // console.log(this.id);\n  var res = uni.getSystemInfoSync();\n  this.statusBarHeight = res.statusBarHeight;\n  // 把礼物js中的数据赋值给礼物数组\n  this.gifts = _gifts.default;\n  // 请求后端接口，获取该直播间详情数据，包括主播信息，和直播间的签名等数据\n  _request.default.get('/live/read/' + this.id).then(function (res) {\n    // 定义一个和res.data一样结构的返回结果 然后就可以直接赋值\n    // console.log(res);\n    _this.detail = res.data;\n    // console.log(this.detail);\n    _this.sign = res.sign;\n  });\n\n  // 请求礼物列表接口\n  _request.default.get('/gift/list').then(function (res) {\n    // console.log('打印看礼物数据');\n    // console.log(res);\n    _this.gifts = res.map(function (item) {\n      item.image = _config.default.imgUrl + item.image;\n      return item;\n    });\n  });\n  // 监听全局事件\n  uni.$on('live', this.handleLiveEvent);\n}), _defineProperty(_components$mounted$d, \"computed\", _objectSpread(_objectSpread({},\n\n(0, _vuex.mapState)({\n  socket: function socket(state) {return state.socket;},\n  token: function token(state) {return state.token;} })), {}, {\n\n  src: function src() {\n    if (this.detail.key == '' || this.sign == '') {\n      return '';\n    }\n    // return `https://mylive.utools.club/live/${this.detail.key}.flv?sign=${this.sign}`;\n    return \"\".concat(_config.default.livePlayBaseUrl, \"/live/\").concat(this.detail.key, \".flv?sign=\").concat(this.sign);\n  } },\n(0, _vuex.mapState)({\n  socket: function socket(state) {return state.socket;},\n  token: function token(state) {return state.token;} }))), _defineProperty(_components$mounted$d, \"methods\",\n\n\n{\n  // 处理直播间事件\n  handleLiveEvent: function handleLiveEvent(e) {\n    var d = e.data;\n    switch (e.type) {\n      case 'online':\n        if (d.action === 'join') {\n          this.list = d.data;\n        }\n        if (d.action === 'leave') {\n          this.list = d.data;\n        }\n        break;\n      case 'comment':\n        this.$refs.danmu.send({\n          id: d.id,\n          name: d.user.name,\n          content: d.content });\n\n        this.content = '';\n        this.$refs.input.close();\n        break;\n      case 'gift':\n        this.$refs.gift.send({\n          username: d.username,\n          avatar: d.avatar,\n          gift_name: d.gift_name,\n          gift_image: d.gift_image,\n          num: d.num });\n\n        break;\n      default:\n        break;}\n\n  },\n  // 加入或离开直播间\n  joinOrLeaveLive: function joinOrLeaveLive(type) {\n    if (this.socket && this.token) {\n      this.socket.emit(type + 'Live', {\n        live_id: this.id,\n        token: this.token });\n\n    }\n  },\n  // 打开送礼物框\n  openGift: function openGift() {\n    this.$refs.giftPopup.open();\n  },\n  // 关闭送礼物框\n  closeGift: function closeGift() {\n    this.$refs.giftPopup.close();\n  },\n  // 进行送礼物操作\n  sendGift: function sendGift() {var _this2 = this;\n    if (this.giftActiveId === 0) {\n      return uni.showToast({\n        title: '请选择要发送的礼物',\n        icon: 'none' });\n\n    }\n    var index = this.gifts.findIndex(function (item) {return item.id === _this2.giftActiveId;});\n    if (index === -1) {\n      return;\n    }\n\n    var g = this.gifts[index];\n\n    if (!this.token && !this.socket) {\n      uni.navigateTo({\n        url: '../login/login' });\n\n      return uni.showToast({\n        title: '请先登录',\n        icon: 'none' });\n\n    }\n    // console.log(g);\n\n    if (this.socket) {\n      this.socket.emit('gift', {\n        live_id: this.id,\n        gift_id: g.id,\n        token: this.token });\n\n    }\n    this.closeGift();\n  },\n  // 跳转到充值页面\n  openCoin: function openCoin() {\n    uni.navigateTo({\n      url: '../coin/coin' });\n\n  },\n  // 打开输入弹幕的对话框\n  openInput: function openInput() {var _this3 = this;\n    this.$store.dispatch('authMethod', function () {\n      _this3.$refs.input.open();\n    });\n    // this.$refs.input.open()\n  },\n  // 提交发送弹幕信息\n  submit: function submit() {\n    if (this.content === '') {\n      return uni.showToast({\n        title: '评论内容不能为空',\n        icon: 'none' });\n\n    }\n    if (!this.token && !this.socket) {\n      uni.navigateTo({\n        url: '../login/login' });\n\n      return uni.showToast({\n        title: '请先登录',\n        icon: 'none' });\n\n    }\n\n    if (this.socket) {\n      this.socket.emit('comment', {\n        live_id: this.id,\n        data: this.content,\n        token: this.token });\n\n    }\n  },\n  //返回上一层\n  back: function back() {\n    uni.navigateBack({\n      delta: 1 });\n\n  } }), _components$mounted$d);exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///55\n");
